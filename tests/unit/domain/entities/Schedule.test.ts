...
describe('Schedule Domain Entity', () => {
  ...
  describe('Schedule Operations', () => {
    ...
    it('should close schedule', async () => {
      ...
      expect(closedSchedule.updatedAt.getTime()).toBeGreaterThanOrEqual(schedule.updatedAt.getTime());
    ...
    it('should reopen schedule', async () => {
      ...
      expect(reopenedSchedule.updatedAt.getTime()).toBeGreaterThanOrEqual(closedSchedule.updatedAt.getTime());
    });
